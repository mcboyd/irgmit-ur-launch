...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_ip", default_value="172.0.0.2", description="IP address by which the robot can be reached."
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    kinematics_params = PathJoinSubstitution(
        [FindPackageShare("irgmit_ur_launch"), "etc", "", "ur5e_ip2_calibration.yaml"]
    )
